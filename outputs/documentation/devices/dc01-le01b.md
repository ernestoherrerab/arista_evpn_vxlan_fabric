...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | default | 192.168.0.176/24 | - |
...
| --------- | --------------- | ------------ | --------- |
| dc01-le01 | Vlan4094 | 10.0.11.4 | Port-Channel31 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet3 | server01_Ethernet2 | *access | *40 | *- | *- | 3 |
| Ethernet4 | server02_Ethernet2 | *access | *41 | *- | *- | 4 |
| Ethernet5 | server07_Ethernet2 | *access | *44 | *- | *- | 5 |
| Ethernet6 | server08_Ethernet2 | *access | *55 | *- | *- | 6 |
| Ethernet7 | server13_Ethernet2 | *access | *51 | *- | *- | 7 |
| Ethernet8 | server14_Ethernet2 | *access | *54 | *- | *- | 8 |
| Ethernet31 | MLAG_PEER_dc01-le01a_Ethernet31 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 31 |
| Ethernet32 | MLAG_PEER_dc01-le01a_Ethernet32 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 31 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_DC01-SP01_Ethernet2 | routed | - | 10.0.9.25/31 | default | 1500 | False | - | - |
| Ethernet2 | P2P_LINK_TO_DC01-SP02_Ethernet2 | routed | - | 10.0.9.27/31 | default | 1500 | False | - | - |
...
| Port-Channel31 | MLAG_PEER_dc01-le01a_Po31 | switched | trunk | - | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 10.0.2.8/32 |
| Loopback1 | VTEP_VXLAN_Tunnel_Source | default | 10.0.3.7/32 |
| Loopback101 | ACME-GENERAL_DIAGNOSTIC | ACME-GENERAL | 10.0.6.8/32 |
| Loopback102 | ACME-DT_DIAGNOSTIC | ACME-DT | 10.0.6.72/32 |
...
| 10.0.9.24 | 65520 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 10.0.9.26 | 65520 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 40 | 10.0.2.8:10040 | 10040:10040 | - | - | learned<br>igmp |
| 41 | 10.0.2.8:10041 | 10041:10041 | - | - | learned<br>igmp |
| 44 | 10.0.2.8:10044 | 10044:10044 | - | - | learned<br>igmp |
| 45 | 10.0.2.8:10045 | 10045:10045 | - | - | learned<br>igmp |
| 50 | 10.0.2.8:10050 | 10050:10050 | - | - | learned<br>igmp |
| 51 | 10.0.2.8:10051 | 10051:10051 | - | - | learned<br>igmp |
| 54 | 10.0.2.8:10054 | 10054:10054 | - | - | learned<br>igmp |
| 55 | 10.0.2.8:10055 | 10055:10055 | - | - | learned<br>igmp |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute | EVPN Multicast |
| --- | ------------------- | ------------ | -------------- |
| ACME-DT | 10.0.2.8:4405 | connected | IPv4: True<br>Transit: False |
| ACME-GENERAL | 10.0.2.8:4401 | connected | IPv4: True<br>Transit: False |
...
router bgp 65521
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER description dc01-le01a
   ...
   neighbor 10.0.9.24 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.0.9.24 remote-as 65520
   neighbor 10.0.9.24 description dc01-sp01_Ethernet2
   neighbor 10.0.9.26 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.0.9.26 remote-as 65520
   neighbor 10.0.9.26 description dc01-sp02_Ethernet2
   neighbor 10.0.12.4 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 10.0.12.4 description dc01-le01a
...
ip igmp snooping vlan 40 querier address 10.0.2.8
ip igmp snooping vlan 41 querier
ip igmp snooping vlan 41 querier address 10.0.2.8
ip igmp snooping vlan 44 querier
ip igmp snooping vlan 44 querier address 10.0.2.8
ip igmp snooping vlan 45 querier
ip igmp snooping vlan 45 querier address 10.0.2.8
ip igmp snooping vlan 50 querier
ip igmp snooping vlan 50 querier address 10.0.2.8
ip igmp snooping vlan 51 querier
ip igmp snooping vlan 51 querier address 10.0.2.8
ip igmp snooping vlan 54 querier
ip igmp snooping vlan 54 querier address 10.0.2.8
ip igmp snooping vlan 55 querier
ip igmp snooping vlan 55 querier address 10.0.2.8
```
...
| -------------- | --------------------- |
| ACME-DT | 10.0.6.72 |
| ACME-GENERAL | 10.0.6.8 |

### Virtual Source NAT Configuration

```eos
!
ip address virtual source-nat vrf ACME-DT address 10.0.6.72
ip address virtual source-nat vrf ACME-GENERAL address 10.0.6.8
```
