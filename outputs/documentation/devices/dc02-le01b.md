...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | default | 192.168.0.186/24 | - |
...
| --------- | --------------- | ------------ | --------- |
| dc02-le01 | Vlan4094 | 10.0.11.4 | Port-Channel31 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet3 | server17_Ethernet2 | *access | *45 | *- | *- | 3 |
| Ethernet4 | server18_Ethernet2 | *access | *43 | *- | *- | 4 |
| Ethernet5 | server22_Ethernet2 | *access | *44 | *- | *- | 5 |
| Ethernet6 | server23_Ethernet2 | *access | *52 | *- | *- | 6 |
| Ethernet7 | server27_Ethernet2 | *access | *53 | *- | *- | 7 |
| Ethernet8 | server28_Ethernet2 | *access | *55 | *- | *- | 8 |
| Ethernet31 | MLAG_PEER_dc02-le01a_Ethernet31 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 31 |
| Ethernet32 | MLAG_PEER_dc02-le01a_Ethernet32 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 31 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_DC02-SP01_Ethernet2 | routed | - | 10.0.10.25/31 | default | 1500 | False | - | - |
| Ethernet2 | P2P_LINK_TO_DC02-SP02_Ethernet2 | routed | - | 10.0.10.27/31 | default | 1500 | False | - | - |
...
!
interface Ethernet1
   description P2P_LINK_TO_DC02-SP01_Ethernet2
   no shutdown
   mtu 1500
   no switchport
   ip address 10.0.10.25/31
   pim ipv4 sparse-mode
!
interface Ethernet2
   description P2P_LINK_TO_DC02-SP02_Ethernet2
   no shutdown
   mtu 1500
   no switchport
   ip address 10.0.10.27/31
   pim ipv4 sparse-mode
!
interface Ethernet3
...
!
interface Ethernet7
   description server27_Ethernet2
   no shutdown
   channel-group 7 mode active
!
interface Ethernet8
   description server28_Ethernet2
   no shutdown
   channel-group 8 mode active
!
interface Ethernet31
   description MLAG_PEER_dc02-le01a_Ethernet31
   no shutdown
   channel-group 31 mode active
!
interface Ethernet32
   description MLAG_PEER_dc02-le01a_Ethernet32
   no shutdown
   channel-group 31 mode active
```
...
| Port-Channel31 | MLAG_PEER_dc02-le01a_Po31 | switched | trunk | - | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel31
   description MLAG_PEER_dc02-le01a_Po31
   no shutdown
   switchport
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 10.0.4.8/32 |
| Loopback1 | VTEP_VXLAN_Tunnel_Source | default | 10.0.5.7/32 |
| Loopback101 | ACME-GENERAL_DIAGNOSTIC | ACME-GENERAL | 10.0.6.136/32 |
| Loopback102 | ACME-DT_DIAGNOSTIC | ACME-DT | 10.0.6.200/32 |
...
interface Loopback101
   ...
   no shutdown
   vrf ACME-GENERAL
   ip address 10.0.6.136/32
!
interface Loopback102
   description ACME-DT_DIAGNOSTIC
   no shutdown
   vrf ACME-DT
   ip address 10.0.6.200/32
```
...
| Vlan4001 |  ACME-GENERAL  |  10.0.12.5/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4005 |  ACME-DT  |  10.0.12.5/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4093 |  default  |  10.0.12.5/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4094 |  default  |  10.0.11.5/31  |  -  |  -  |  -  |  -  |  -  |
...
| 10.0.10.24 | 65560 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 10.0.10.26 | 65560 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 10.0.12.4 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
| 10.0.12.4 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | ACME-DT | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - |
| 10.0.12.4 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | ACME-GENERAL | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 42 | 10.0.4.8:10042 | 10042:10042 | - | - | learned<br>igmp |
| 43 | 10.0.4.8:10043 | 10043:10043 | - | - | learned<br>igmp |
| 44 | 10.0.4.8:10044 | 10044:10044 | - | - | learned<br>igmp |
| 45 | 10.0.4.8:10045 | 10045:10045 | - | - | learned<br>igmp |
| 49 | 10.0.4.8:10049 | 10049:10049 | - | - | learned<br>igmp |
| 52 | 10.0.4.8:10052 | 10052:10052 | - | - | learned<br>igmp |
| 53 | 10.0.4.8:10053 | 10053:10053 | - | - | learned<br>igmp |
| 54 | 10.0.4.8:10054 | 10054:10054 | - | - | learned<br>igmp |
| 55 | 10.0.4.8:10055 | 10055:10055 | - | - | learned<br>igmp |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute | EVPN Multicast |
| --- | ------------------- | ------------ | -------------- |
| ACME-DT | 10.0.4.8:4405 | connected | IPv4: True<br>Transit: False |
| ACME-GENERAL | 10.0.4.8:4401 | connected | IPv4: True<br>Transit: False |
...
router bgp 65561
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER description dc02-le01a
   ...
   neighbor 10.0.10.24 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.0.10.24 remote-as 65560
   neighbor 10.0.10.24 description dc02-sp01_Ethernet2
   neighbor 10.0.10.26 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.0.10.26 remote-as 65560
   neighbor 10.0.10.26 description dc02-sp02_Ethernet2
   neighbor 10.0.12.4 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 10.0.12.4 description dc02-le01a
...
ip igmp snooping vlan 42 querier address 10.0.4.8
ip igmp snooping vlan 43 querier
ip igmp snooping vlan 43 querier address 10.0.4.8
ip igmp snooping vlan 44 querier
ip igmp snooping vlan 44 querier address 10.0.4.8
ip igmp snooping vlan 45 querier
ip igmp snooping vlan 45 querier address 10.0.4.8
ip igmp snooping vlan 49 querier
ip igmp snooping vlan 49 querier address 10.0.4.8
ip igmp snooping vlan 52 querier
ip igmp snooping vlan 52 querier address 10.0.4.8
ip igmp snooping vlan 53 querier
ip igmp snooping vlan 53 querier address 10.0.4.8
ip igmp snooping vlan 54 querier
ip igmp snooping vlan 54 querier address 10.0.4.8
ip igmp snooping vlan 55 querier
ip igmp snooping vlan 55 querier address 10.0.4.8
```
...
| -------------- | --------------------- |
| ACME-DT | 10.0.6.200 |
| ACME-GENERAL | 10.0.6.136 |

### Virtual Source NAT Configuration

```eos
!
ip address virtual source-nat vrf ACME-DT address 10.0.6.200
ip address virtual source-nat vrf ACME-GENERAL address 10.0.6.136
```
