...
| Loopback101 | ACME-GENERAL_DIAGNOSTIC | ACME-GENERAL | 10.0.6.12/32 |
| Loopback102 | ACME-DT_DIAGNOSTIC | ACME-DT | 10.0.6.76/32 |
...
interface Loopback101
   ...
   no shutdown
   vrf ACME-GENERAL
   ip address 10.0.6.12/32
!
interface Loopback102
   description ACME-DT_DIAGNOSTIC
   no shutdown
   vrf ACME-DT
   ip address 10.0.6.76/32
```
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 40 | 10.0.2.12:10040 | 10040:10040 | - | - | learned<br>igmp |
| 41 | 10.0.2.12:10041 | 10041:10041 | - | - | learned<br>igmp |
| 44 | 10.0.2.12:10044 | 10044:10044 | - | - | learned<br>igmp |
| 45 | 10.0.2.12:10045 | 10045:10045 | - | - | learned<br>igmp |
| 50 | 10.0.2.12:10050 | 10050:10050 | - | - | learned<br>igmp |
| 51 | 10.0.2.12:10051 | 10051:10051 | - | - | learned<br>igmp |
| 54 | 10.0.2.12:10054 | 10054:10054 | - | - | learned<br>igmp |
| 55 | 10.0.2.12:10055 | 10055:10055 | - | - | learned<br>igmp |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute | EVPN Multicast |
| --- | ------------------- | ------------ | -------------- |
| ACME-DT | 10.0.2.12:4405 | connected | IPv4: True<br>Transit: False |
| ACME-GENERAL | 10.0.2.12:4401 | connected | IPv4: True<br>Transit: False |
...
ip igmp snooping vlan 40 querier address 10.0.2.12
ip igmp snooping vlan 41 querier
ip igmp snooping vlan 41 querier address 10.0.2.12
ip igmp snooping vlan 44 querier
ip igmp snooping vlan 44 querier address 10.0.2.12
ip igmp snooping vlan 45 querier
ip igmp snooping vlan 45 querier address 10.0.2.12
ip igmp snooping vlan 50 querier
ip igmp snooping vlan 50 querier address 10.0.2.12
ip igmp snooping vlan 51 querier
ip igmp snooping vlan 51 querier address 10.0.2.12
ip igmp snooping vlan 54 querier
ip igmp snooping vlan 54 querier address 10.0.2.12
ip igmp snooping vlan 55 querier
ip igmp snooping vlan 55 querier address 10.0.2.12
```
...
| -------------- | --------------------- |
| ACME-DT | 10.0.6.76 |
| ACME-GENERAL | 10.0.6.12 |

### Virtual Source NAT Configuration

```eos
!
ip address virtual source-nat vrf ACME-DT address 10.0.6.76
ip address virtual source-nat vrf ACME-GENERAL address 10.0.6.12
```
