...
| Loopback101 | ACME-GENERAL_DIAGNOSTIC | ACME-GENERAL | 10.0.6.135/32 |
| Loopback102 | ACME-DT_DIAGNOSTIC | ACME-DT | 10.0.6.199/32 |
...
interface Loopback101
   ...
   no shutdown
   vrf ACME-GENERAL
   ip address 10.0.6.135/32
!
interface Loopback102
   description ACME-DT_DIAGNOSTIC
   no shutdown
   vrf ACME-DT
   ip address 10.0.6.199/32
```
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 42 | 10.0.4.7:10042 | 10042:10042 | - | - | learned<br>igmp |
| 43 | 10.0.4.7:10043 | 10043:10043 | - | - | learned<br>igmp |
| 44 | 10.0.4.7:10044 | 10044:10044 | - | - | learned<br>igmp |
| 45 | 10.0.4.7:10045 | 10045:10045 | - | - | learned<br>igmp |
| 49 | 10.0.4.7:10049 | 10049:10049 | - | - | learned<br>igmp |
| 52 | 10.0.4.7:10052 | 10052:10052 | - | - | learned<br>igmp |
| 53 | 10.0.4.7:10053 | 10053:10053 | - | - | learned<br>igmp |
| 54 | 10.0.4.7:10054 | 10054:10054 | - | - | learned<br>igmp |
| 55 | 10.0.4.7:10055 | 10055:10055 | - | - | learned<br>igmp |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute | EVPN Multicast |
| --- | ------------------- | ------------ | -------------- |
| ACME-DT | 10.0.4.7:4405 | connected | IPv4: True<br>Transit: False |
| ACME-GENERAL | 10.0.4.7:4401 | connected | IPv4: True<br>Transit: False |
...
ip igmp snooping vlan 42 querier address 10.0.4.7
ip igmp snooping vlan 43 querier
ip igmp snooping vlan 43 querier address 10.0.4.7
ip igmp snooping vlan 44 querier
ip igmp snooping vlan 44 querier address 10.0.4.7
ip igmp snooping vlan 45 querier
ip igmp snooping vlan 45 querier address 10.0.4.7
ip igmp snooping vlan 49 querier
ip igmp snooping vlan 49 querier address 10.0.4.7
ip igmp snooping vlan 52 querier
ip igmp snooping vlan 52 querier address 10.0.4.7
ip igmp snooping vlan 53 querier
ip igmp snooping vlan 53 querier address 10.0.4.7
ip igmp snooping vlan 54 querier
ip igmp snooping vlan 54 querier address 10.0.4.7
ip igmp snooping vlan 55 querier
ip igmp snooping vlan 55 querier address 10.0.4.7
```
...
| -------------- | --------------------- |
| ACME-DT | 10.0.6.199 |
| ACME-GENERAL | 10.0.6.135 |

### Virtual Source NAT Configuration

```eos
!
ip address virtual source-nat vrf ACME-DT address 10.0.6.199
ip address virtual source-nat vrf ACME-GENERAL address 10.0.6.135
```
