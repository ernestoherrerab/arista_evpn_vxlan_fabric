...
| Loopback101 | ACME-GENERAL_DIAGNOSTIC | ACME-GENERAL | 10.0.6.14/32 |
| Loopback102 | ACME-DT_DIAGNOSTIC | ACME-DT | 10.0.6.78/32 |
...
interface Loopback101
   ...
   no shutdown
   vrf ACME-GENERAL
   ip address 10.0.6.14/32
!
interface Loopback102
   description ACME-DT_DIAGNOSTIC
   no shutdown
   vrf ACME-DT
   ip address 10.0.6.78/32
```
...
| 51 | 10051 | - | 232.0.0.50 |
| 55 | 10055 | - | 232.0.0.54 |
| 200 | 10200 | - | 232.0.0.199 |
| 201 | 10201 | - | 232.0.0.200 |
| 202 | 10202 | - | 232.0.0.201 |
| 203 | 10203 | - | 232.0.0.202 |
| 208 | 10208 | - | 232.0.0.207 |
| 209 | 10209 | - | 232.0.0.208 |
| 210 | 10210 | - | 232.0.0.209 |
| 211 | 10211 | - | 232.0.0.210 |
...
interface Vxlan1
   ...
   vxlan vlan 200 multicast group 232.0.0.199
   vxlan vlan 201 multicast group 232.0.0.200
   vxlan vlan 202 multicast group 232.0.0.201
   vxlan vlan 203 multicast group 232.0.0.202
   vxlan vlan 208 multicast group 232.0.0.207
   vxlan vlan 209 multicast group 232.0.0.208
   vxlan vlan 210 multicast group 232.0.0.209
   vxlan vlan 211 multicast group 232.0.0.210
...
| 10.0.9.72 | 65520 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 10.0.9.74 | 65520 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 41 | 10.0.2.14:10041 | 10041:10041 | - | - | learned<br>igmp |
| 45 | 10.0.2.14:10045 | 10045:10045 | - | - | learned<br>igmp |
| 51 | 10.0.2.14:10051 | 10051:10051 | - | - | learned<br>igmp |
| 55 | 10.0.2.14:10055 | 10055:10055 | - | - | learned<br>igmp |
| 200 | 10.0.2.14:10200 | 10200:10200 | - | - | learned<br>igmp |
| 201 | 10.0.2.14:10201 | 10201:10201 | - | - | learned<br>igmp |
| 202 | 10.0.2.14:10202 | 10202:10202 | - | - | learned<br>igmp |
| 203 | 10.0.2.14:10203 | 10203:10203 | - | - | learned<br>igmp |
| 208 | 10.0.2.14:10208 | 10208:10208 | - | - | learned<br>igmp |
| 209 | 10.0.2.14:10209 | 10209:10209 | - | - | learned<br>igmp |
| 210 | 10.0.2.14:10210 | 10210:10210 | - | - | learned<br>igmp |
| 211 | 10.0.2.14:10211 | 10211:10211 | - | - | learned<br>igmp |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute | EVPN Multicast |
| --- | ------------------- | ------------ | -------------- |
| ACME-DT | 10.0.2.14:4405 | connected<br>static | IPv4: True<br>Transit: False |
| ACME-GENERAL | 10.0.2.14:4401 | connected<br>static | IPv4: True<br>Transit: False |
...
ip igmp snooping vlan 41 querier address 10.0.2.14
ip igmp snooping vlan 45 querier
ip igmp snooping vlan 45 querier address 10.0.2.14
ip igmp snooping vlan 51 querier
ip igmp snooping vlan 51 querier address 10.0.2.14
ip igmp snooping vlan 55 querier
ip igmp snooping vlan 55 querier address 10.0.2.14
ip igmp snooping vlan 200 querier
ip igmp snooping vlan 200 querier address 10.0.2.14
ip igmp snooping vlan 201 querier
ip igmp snooping vlan 201 querier address 10.0.2.14
ip igmp snooping vlan 202 querier
ip igmp snooping vlan 202 querier address 10.0.2.14
ip igmp snooping vlan 203 querier
ip igmp snooping vlan 203 querier address 10.0.2.14
ip igmp snooping vlan 208 querier
ip igmp snooping vlan 208 querier address 10.0.2.14
ip igmp snooping vlan 209 querier
ip igmp snooping vlan 209 querier address 10.0.2.14
ip igmp snooping vlan 210 querier
ip igmp snooping vlan 210 querier address 10.0.2.14
ip igmp snooping vlan 211 querier
ip igmp snooping vlan 211 querier address 10.0.2.14
```
...
| Ethernet1 | - | IPv4 | - | - | - |
| Ethernet2 | - | IPv4 | - | - | - |
| Vlan200 | ACME-GENERAL | IPv4 | - | - | - |
| Vlan201 | ACME-DT | IPv4 | - | - | - |
| Vlan202 | ACME-GENERAL | IPv4 | - | - | - |
| Vlan203 | ACME-DT | IPv4 | - | - | - |
...
| -------------- | --------------------- |
| ACME-DT | 10.0.6.78 |
| ACME-GENERAL | 10.0.6.14 |

### Virtual Source NAT Configuration

```eos
!
ip address virtual source-nat vrf ACME-DT address 10.0.6.78
ip address virtual source-nat vrf ACME-GENERAL address 10.0.6.14
```
