...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | default | 192.168.0.155/24 | - |
...
| --------- | ----------- | ---- | ------- | ---------- | --- | --- | -------- | ------ | ------- |
| Port-channel1 | LINK_TO_LEAF | routed | - | 10.4.45.117/24 | ACME | - | False | - | - |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | Router_ID | default | 10.248.0.17/32 |
...
| --- | ------------------ | ----------- | -------------- | ----------------------- | --- | ---------- | ------ |
| ACME | 0.0.0.0/0 | 10.4.45.1 | - | 1 | - | - | - |

#### Static Routes Device Configuration

```eos
!
ip route vrf ACME 0.0.0.0/0 10.4.45.1
```
